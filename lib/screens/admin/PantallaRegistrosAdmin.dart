...
class PantallaRegistrosAdmin extends StatefulWidget {
  ...
  @override
  State<PantallaRegistrosAdmin> createState() => _PantallaRegistrosAdminState();
}
...
class _PantallaRegistrosAdminState extends State<PantallaRegistrosAdmin> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                const Text("Hacer admin al usuario"),
                Switch(
                  value: _esAdmin,
